...
while (lin < 9) {
    if (c == 3) {
        ...
        //criando as colunas (col3 x lin 1)
        var columns = document.createElement("div");
        columns.className = "col-md-4 identificador" + x;
        x++;
        linha.appendChild(columns);
    }
}
...
while (i < 25) {
    ...
    //criando o titulo do card
    var cardTitle = document.createElement("h5");
    cardTitle.className = "card-title";
    cardTitle.innerText = dados[i].property_type;
    cardBody.appendChild(cardTitle);
    //criando o texto do carrd
    var cardText = document.createElement("p");
    cardText.className = "card-text";
    cardText.innerText = dados[i].name;
    cardBody.appendChild(cardText);
    var cardPrice = document.createElement("p");
    cardPrice.className = "card-text";
    cardPrice.innerText = dados[i].price;
    cardBody.appendChild(cardPrice);

    //atribuindo tudo na mesma div de teste
    var element = document.getElementsByClassName("identificador" + i);
